...
import { auth, createUserWithEmailAndPassword, sendEmailVerification, doc, setDoc, db } from "./firebaseInitializing.js";
    ...
    if (password === passwordRepeat && password.length>=6) {
        try {
            ...
            await sendEmailVerification(user, {
              url: 'https://nikapomazova.github.io/emilyhi/logIn.html', //redirect to verified after verification
            });
